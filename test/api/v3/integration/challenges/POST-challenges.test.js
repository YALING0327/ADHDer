...
describe('POST /challenges', () => {
  ...
  context('creating a Challenge for a Group Plan', () => {
    ...
    it('does not set adhder_official category for non-admins', async () => {
      const testCategory = { _id: '65c1172997c0b24600371ea9', slug: 'adhder_official', name: 'adhder_official' };
      await expect(groupLeader.post('/challenges', {
        group: group._id,
        name: 'Test Challenge',
        shortName: 'TC Label',
    ...
    it('sets adhder_official category for admins', async () => {
      await groupLeader.updateOne({
        permissions: {
          challengeAdmin: true,
        },
    ...
    it('sets official if the adhder_official category is set for admins', async () => {
      await groupLeader.updateOne({
        permissions: {
          challengeAdmin: true,
        },
