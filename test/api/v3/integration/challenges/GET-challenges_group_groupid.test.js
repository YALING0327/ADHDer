...
describe('GET challenges/groups/:groupId', () => {
  ...
  context('Tavern', () => {
    ...
    it('should return tavern challenges using ID "adhderapp"', async () => {
      const challenges = await user.get('/challenges/groups/adhderapp');
    ...
    context('official challenge is present', () => {
      ...
      before(async () => {
        ...
        officialChallenge = await generateChallenge(user, tavern, {
          categories: [{
            name: 'adhder_official',
            slug: 'adhder_official',
          }],
          prize: 1,
        });
      ...
      it('should return newest challenges first, after official ones', async () => {
        let challenges = await user.get('/challenges/groups/adhderapp');
        ...
        challenges = await user.get('/challenges/groups/adhderapp');
