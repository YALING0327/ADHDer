...
describe('Apple Payments', () => {
  ...
  describe('verifyPurchase', () => {
    ...
    beforeEach(() => {
      token = 'testToken';
      sku = 'com.adhderapp.ios.adhder.iap.21gems';
      user = new User();
      ...
      iapGetPurchaseDataStub = sinon.stub(iap, 'getPurchaseData')
        .returns([{
          productId: 'com.adhderapp.ios.Adhder.21gems',
          transactionId: token,
        }]);
    ...
    const gemsCanPurchase = [
      {
        productId: 'com.adhderapp.ios.Adhder.4gems',
        gemsBlock: '4gems',
      },
      {
        productId: 'com.adhderapp.ios.Adhder.20gems',
        gemsBlock: '21gems',
      },
      {
        productId: 'com.adhderapp.ios.Adhder.21gems',
      ...
      {
        productId: 'com.adhderapp.ios.Adhder.42gems',
        gemsBlock: '42gems',
      },
      {
        productId: 'com.adhderapp.ios.Adhder.84gems',
        gemsBlock: '84gems',
      },
    ];
    ...
    it('gifts gems', async () => {
      ...
      expect(paymentBuySkuStub).to.be.calledWith({
        ...
        paymentMethod: applePayments.constants.PAYMENT_METHOD_APPLE,
        sku: 'com.adhderapp.ios.Adhder.4gems',
        headers,
      });
    });
  });
  ...
  describe('subscribe', () => {
    ...
    beforeEach(() => {
      ...
      sku = 'com.adhderapp.ios.adhder.subscription.3month';
    ...
    const subOptions = [
      ...
      {
        sku: 'com.adhderapp.ios.adhder.subscription.6month',
        subKey: 'basic_6mo',
      },
      {
        sku: 'com.adhderapp.ios.adhder.subscription.12month',
        subKey: 'basic_12mo',
      },
    ];
