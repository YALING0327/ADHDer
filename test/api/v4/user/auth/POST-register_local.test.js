...
describe('POST /user/auth/local/register', () => {
  context('username and email are free', () => {
    ...
    it('fails on a adhder.com email', async () => {
      const username = generateRandomUserName();
      const email = `${username}@adhder.com`;
      const password = 'password';
    ...
    it('fails on a adhderapp.com email', async () => {
      const username = generateRandomUserName();
      const email = `${username}@adhderapp.com`;
      const password = 'password';
  ...
  context('successful login with adhder-web header', () => {
    let api; let username; let email; let
      password;

    beforeEach(() => {
      api = requester({}, { 'x-client': 'adhder-web' });
      username = generateRandomUserName();
      email = `${username}@example.com`;
      password = 'password';
    });
