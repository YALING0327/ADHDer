...
describe('achievements', () => {
  ...
  describe('unearned seasonal achievements', () => {
    ...
    it('adhderDays and habitBirthdays achievements exist with counts', () => {
      const { adhderDays } = seasonalAchievs;
      const { habitBirthdays } = seasonalAchievs;

      expect(adhderDays).to.exist;
      expect(adhderDays).to.have.property('optionalCount')
        .that.is.a('number');
