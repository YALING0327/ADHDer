...
class QuestMenuHeader: UIView {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        hearthIconView.image = AdhderIcons.imageOfHeartDarkBg
        ...
        pendingDamageIcon.image = AdhderIcons.imageOfDamage
    ...
    func bossArtTapped() {
        ...
        let alertController = AdhderAlertController.alert(title: L10n.whatsWorldBoss)
