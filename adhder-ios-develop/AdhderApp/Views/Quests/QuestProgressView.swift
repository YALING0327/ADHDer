...
class QuestProgressView: UIView {
    ...
    private func setupView() {
        if let view = viewFromNibForClass() {
            ...
            healthProgressView.icon = AdhderIcons.imageOfHeartLightBg
    ...
    func configure(quest: QuestProtocol) {
        ...
        backgroundView.image = AdhderIcons.imageOfQuestBackground(bossColorDark: colorDark,
    ...
    func rageStrikeButtonTapped() {
        ...
        let alertController = AdhderAlertController.alert(title: L10n.WorldBoss.rageStrikeExplanationButton, attributedMessage: attributedString)
