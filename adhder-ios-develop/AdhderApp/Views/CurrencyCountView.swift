...
class CurrencyCountView: UIView {
    ...
    private let currencyImageView: UIImageView = UIImageView(image: AdhderIcons.imageOfGold)
    ...
    private func updateSize() {
        ...
        if currency == .gem {
            currencyImageView.image = (viewSize == .normal ? AdhderIcons.imageOfGem : AdhderIcons.imageOfGem_36)
        }
