...
class AchievementAlertController: AdhderAlertController {
    ...
    func setNotification(notification: NotificationProtocol, isOnboarding: Bool, isLastOnboardingAchievement: Bool) {
        ...
        if notification.type == AdhderNotificationType.achievementGeneric {
            key = notification.achievementKey ?? ""
        }
        switch key {
        case AdhderNotificationType.achievementPartyUp.rawValue:
            configureAlert(title: L10n.partyUpTitle, text: L10n.partyUpDescription, iconName: "partyUp")
        case AdhderNotificationType.achievementPartyOn.rawValue:
            configureAlert(title: L10n.partyOnTitle, text: L10n.partyOnDescription, iconName: "partyOn")
        case AdhderNotificationType.achievementBeastMaster.rawValue:
            configureAlert(title: L10n.beastMasterTitle, text: L10n.beastMasterDescription, iconName: "rat")
        case AdhderNotificationType.achievementMountMaster.rawValue:
            configureAlert(title: L10n.mountMasterTitle, text: L10n.mountMasterDescription, iconName: "wolf")
        case AdhderNotificationType.achievementTriadBingo.rawValue:
            configureAlert(title: L10n.triadBingoTitle, text: L10n.triadBingoDescription, iconName: "triadbingo")
        case AdhderNotificationType.achievementGuildJoined.rawValue:
            configureAlert(title: L10n.guildJoinedTitle, text: L10n.guildJoinedDescription, iconName: "guild")
        case AdhderNotificationType.achievementChallengeJoined.rawValue:
            configureAlert(title: L10n.challengeJoinedTitle, text: L10n.challengeJoinedDescription, iconName: "challenge")
            
        case AdhderNotificationType.achievementAllYourBase.rawValue,
             AdhderNotificationType.achievementBackToBasics.rawValue,
             AdhderNotificationType.achievementJustAddWater.rawValue,
             AdhderNotificationType.achievementLostMasterclasser.rawValue,
             AdhderNotificationType.achievementMindOverMatter.rawValue,
             AdhderNotificationType.achievementDustDevil.rawValue,
             AdhderNotificationType.achievementAridAuthority.rawValue,
             AdhderNotificationType.achievementMonsterMagus.rawValue,
             AdhderNotificationType.achievementUndeadUndertaker.rawValue,
             AdhderNotificationType.achievementPrimedForPainting.rawValue,
             AdhderNotificationType.achievementPearlyPro.rawValue,
             AdhderNotificationType.achievementTickledPink.rawValue,
             AdhderNotificationType.achievementRosyOutlook.rawValue,
             AdhderNotificationType.achievementBugBonanza.rawValue,
             AdhderNotificationType.achievementBareNecessities.rawValue,
             AdhderNotificationType.achievementFreshwaterFriends.rawValue,
             AdhderNotificationType.achievementGoodAsGold.rawValue,
             AdhderNotificationType.achievementAllThatGlitters.rawValue,
             AdhderNotificationType.achievementBoneCollector.rawValue,
             AdhderNotificationType.achievementSkeletonCrew.rawValue:
        ...
        case AdhderNotificationType.achievementInvitedFriend.rawValue:
        ...
        case AdhderNotificationType.achievementOnboardingComplete.rawValue:
