...
public enum AdhderPromotionType {
    case gemsAmount
    case gemsPrice
    case subscription
    case survey
    
    static func getPromoFromKey(key: String, startDate: Date?, endDate: Date?) -> AdhderPromotion? {
        switch key {
...
protocol AdhderPromotion {
    var identifier: String { get }
    var promoType: AdhderPromotionType { get }
...
protocol AdhderWebPromotion: AdhderPromotion {
    var url: URL? { get }
}

class FallExtraGemsPromotion: AdhderPromotion {

    var identifier = "fall_extra_gems"
    var promoType: AdhderPromotionType = .gemsAmount
...
class SpookyExtraGemsPromotion: AdhderPromotion {
...
class GiftOneGetOnePromotion: AdhderPromotion {

    var identifier = "g1g1"
    var promoType: AdhderPromotionType = .subscription
    var isWebPromo: Bool = false
    var startDate: Date
    var endDate: Date
...
class Survey2021Promotion: AdhderWebPromotion {

    var identifier = "survey2021"
    var promoType: AdhderPromotionType = .survey
