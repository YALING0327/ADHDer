...
enum AppIconName: String {
    ...
    case prideAdhder = "Pride"
    case prideAdhderAlt = "Pride Alternative"
    case prideAdhderAltBlack = "Pride Alternative Black"
    ...
    var fileName: String? {
        ...
        case .prideAdhder:
            return "PrideAdhder"
        case .prideAdhderAlt:
            return "PrideAdhderAlt"
        case .prideAdhderAltBlack:
            return "PrideAdhderAltBlack"
        case .maroon:
            return "Maroon"
        case .red:
            return "Red"
