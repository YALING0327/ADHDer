...
class GemViewController: BaseCollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        AdhderAnalytics.shared.logNavigationEvent("navigated gem screen")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var amount = 0
        if product.productIdentifier == "com.adhderapp.ios.Adhder.4gems" {
            amount = 4
        } else if product.productIdentifier == "com.adhderapp.ios.Adhder.21gems" {
            amount = 21
        } else if product.productIdentifier == "com.adhderapp.ios.Adhder.42gems" {
            amount = 42
        } else if product.productIdentifier == "com.adhderapp.ios.Adhder.84gems" {
            amount = 84
        }
    ...
    private func showGiftSubscriptionModal() {
        let alertController = AdhderAlertController(title: L10n.giftRecipientTitle, message: L10n.giftRecipientSubtitle)
    ...
    @IBAction func giftGemsTapped(_ sender: Any) {
        let alertController = AdhderAlertController(title: L10n.giftGemsAlertTitle)
