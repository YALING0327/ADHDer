...
class PartyDetailViewController: GroupDetailViewController {
    ...
    override func viewDidLoad() {
        ...
        questTitleDisclosureView.image = AdhderIcons.imageOfDisclosureArrow
        ...
        let refreshControl = AdhderRefresControl()
    ...
    private func showTransferOwnershipDialog(memberID: String, displayName: String) {
        let alert = AdhderAlertController(title: L10n.Party.transferOwnershipTitle, message: L10n.Party.transferOwnershipDescription(displayName))
    ...
    private func showRemoveMemberDialog(memberID: String, displayName: String) {
        let alert = AdhderAlertController(title: L10n.Party.removeMemberTitle(displayName))
