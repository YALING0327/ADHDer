...
class UserProfileViewController: BaseTableViewController {
    ...
    private func showBlockDialog() {
        let alert = AdhderAlertController(title: L10n.blockUsername(username ?? member?.profile?.name ?? userID ?? ""), message: L10n.blockDescription)
    ...
    private func showBanDialog() {
        ...
        let alert = AdhderAlertController(title: isBanned ? L10n.unbanUserConfirm : L10n.banUserConfirm)
        alert.addAction(title: L10n.block, style: .destructive, isMainAction: true) {[weak self] _ in
    ...
    private func showShadowMuteDialog() {
        ...
        let alert = AdhderAlertController(title: isShadowMuted ? L10n.unshadowMuteUserConfirm : L10n.shadowMuteUserConfirm)
        alert.addAction(title: L10n.block, style: .destructive, isMainAction: true) {[weak self] _ in
    ...
    private func showMuteDialog() {
        ...
        let alert = AdhderAlertController(title: isMuted ? L10n.unmuteUserConfirm : L10n.muteUserConfirm)
        alert.addAction(title: L10n.block, style: .destructive, isMainAction: true) {[weak self] _ in
