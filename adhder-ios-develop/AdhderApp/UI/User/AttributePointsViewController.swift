...
class AttributePointsViewController: BaseUIViewController {
    ...
    var refreshControl = AdhderRefresControl()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        pointsToAllocateLeftView.image = AdhderIcons.imageOfAttributeSparklesLeft
        pointsToAllocateRightView.image = AdhderIcons.imageOfAttributeSparklesRight
        ...
        distributeEvenlyHelpView.image = AdhderIcons.imageOfInfoIcon()
        distributeClassHelpView.image = AdhderIcons.imageOfInfoIcon()
        distributeTaskHelpView.image = AdhderIcons.imageOfInfoIcon()
    ...
    override func applyTheme(theme: Theme) {
        ...
        distributeEvenlyCheckmark.image = AdhderIcons.imageOfCheckmark(checkmarkColor: theme.tintColor, percentage: 1.0)
        distributeClassCheckmark.image = AdhderIcons.imageOfCheckmark(checkmarkColor: theme.tintColor, percentage: 1.0)
        distributeTaskCheckmark.image = AdhderIcons.imageOfCheckmark(checkmarkColor: theme.tintColor, percentage: 1.0)
    ...
    func showHelpView(_ message: String) {
        let alert = AdhderAlertController.alert(title: nil, message: message)
        alert.addOkAction()
        alert.show()
    }
