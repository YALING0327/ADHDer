...
class ItemsViewController: BaseTableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if isHatching {
            ...
            AdhderAnalytics.shared.log("Items CTA tap", withEventProperties: [
    ...
    @objc
    func openMarket() {
        AdhderAnalytics.shared.log("Items CTA tap", withEventProperties: ["eventCategory": "behaviour",
                                                                            "hitType": "event",
                                                                            "area": "bottom"])
        if itemType == "quests" {
            RouterHandler.shared.handle(.questShop)
    ...
    private func showQuestDialog(quest: QuestProtocol) {
        let alertController = AdhderAlertController(title: quest.text)
        ...
        textView.attributedText = try? AdhderMarkdownHelper.toAdhderAttributedString(quest.notes ?? "")
