...
struct DifficultyPicker: View {
    ...
    func difficultyOption(text: String, value: Float) -> some View {
        ...
        VStack {
            ...
            Group {
                Image(uiImage: AdhderIcons.imageOfTaskDifficultyStars(taskTintColor: .white, difficulty: value == 0.1 ? 0.1 : CGFloat(value), isActive: true).withRenderingMode(.alwaysTemplate))
...
struct HabitControlsFormView: View {
    ...
    var body: some View {
        HStack {
            buildOption(text: L10n.Tasks.Form.positive, icon: AdhderIcons.imageOfHabitControlPlus(taskTintColor: taskColor, isActive: isUp), isActive: $isUp)
            buildOption(text: L10n.Tasks.Form.negative, icon: AdhderIcons.imageOfHabitControlMinus(taskTintColor: taskColor, isActive: isDown), isActive: $isDown)
        }
    }
}
...
struct RewardAmountView: View {
    ...
    var body: some View {
        HStack {
            ...
            HStack {
                Image(uiImage: AdhderIcons.imageOfGold)
    ...
    private var textFields: some View {
        VStack(alignment: .leading, spacing: 4) {
            HStack {
                ...
                Image(uiImage: AdhderIcons.imageOfLocked().withRenderingMode(.alwaysTemplate)).foregroundColor(viewModel.darkestTaskTintColor)
                }
            }
