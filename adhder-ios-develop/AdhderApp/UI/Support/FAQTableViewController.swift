...
class FAQViewController: BaseUIViewController, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        supportEmail = configRepository.string(variable: .supportEmail, defaultValue: "admin@adhder.com")
    ...
    private static let mechanics = [
        ["title": L10n.healthPoints, "subtitle": "HP", "icon": AdhderIcons.imageOfHeartLarge, "text": L10n.healthDescription],
        ["title": L10n.experiencePoints, "subtitle": "EXP", "icon": AdhderIcons.imageOfExperienceReward, "text": L10n.experienceDescription],
        ["title": L10n.manaPoints, "subtitle": "MP", "icon": AdhderIcons.imageOfMagic, "text": L10n.manaDescription],
        ["title": L10n.gold, "subtitle": L10n.currency, "icon": AdhderIcons.imageOfGoldReward, "text": L10n.goldDescription],
        ["title": L10n.gems, "subtitle": L10n.premiumCurrency, "icon": AdhderIcons.imageOfGem, "text": L10n.gemsDescription],
        ["title": L10n.mysticHourglasses, "subtitle": L10n.premiumCurrency, "icon": AdhderIcons.imageOfHourglass, "text": L10n.hourglassesDescription],
        ["title": L10n.statAllocation, "subtitle": "STR, CON, INT, PER", "icon": AdhderIcons.imageOfStats, "text": L10n.statDescription]
    ]
    ...
    private func showNoEmailAlert() {
        let alert = AdhderAlertController(title: L10n.About.noEmailTitle, message: L10n.About.noEmailMessage(supportEmail))
