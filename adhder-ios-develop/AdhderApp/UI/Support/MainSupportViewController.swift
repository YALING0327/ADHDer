...
class MainSupportViewController: BaseUIViewController {
    ...
    @IBOutlet weak var suggestionsButton: AdhderButton!
    @IBOutlet weak var resetTutorialContainer: UIView!
    @IBOutlet weak var resetTutorialButton: AdhderButton!
