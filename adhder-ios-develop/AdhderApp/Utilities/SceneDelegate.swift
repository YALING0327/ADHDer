...
class SceneDelegate: NSObject, UIWindowSceneDelegate {
    ...
    private func handleShortcutItem(shortcutItem: UIApplicationShortcutItem) -> Bool {
        if shortcutItem.type == "com.adhderapp.adhder.ios.newhabit" {
            return RouterHandler.shared.handle(urlString: "/user/tasks/habit/add")
        } else if shortcutItem.type == "com.adhderapp.adhder.ios.newdaily" {
            return RouterHandler.shared.handle(urlString: "/user/tasks/daily/add")
        } else if shortcutItem.type == "com.adhderapp.adhder.ios.newtodo" {
    ...
    func setupTheme() {
        ...
        AdhderAnalytics.shared.setUserProperty(key: "theme", value: themeName.rawValue)
    }
    ...
    func reloadWidgetData() {
        ...
        WidgetCenter.shared.getCurrentConfigurations { result in
            ...
            case let .success(info):
                AdhderAnalytics.shared.setUserProperty(key: "widgetCount", value: String(info.count))
