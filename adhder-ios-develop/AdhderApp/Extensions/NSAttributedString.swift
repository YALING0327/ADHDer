...
extension AttributedString {
    ...
    func withCommunityGuidelinesLinked() -> AttributedString {
        return withLinkedWord(word: L10n.communityGuidelines, link: "https://adhder.com/static/community-guidelines")
    }
    
    func withTermsOfServiceLinked() -> AttributedString {
        return withLinkedWord(word: L10n.termsOfService, link: "https://adhder.com/static/terms")
    }
}
