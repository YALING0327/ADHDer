...
public enum L10n {
  ...
  /// You can change your password to reset it. Once it is reset, you will need to log back in to any other devices you use Adhder on and provide the new API Token to third-party tools you may use.
  ...
  /// Celebrate Adhder’s 10th birthday with gifts and exclusive items below!
  ...
  /// To create a Challenge, log in to the Adhder website then tap the “Create” button on the “My Challenges” screen.
  ...
  /// To create a Guild, log in to the Adhder website then tap the “Create” button on the “My Guilds” screen.
  ...
  /// I earned a new achievement in Adhder!
  ...
  /// To end a Challenge, log in to the Adhder website then tap the “End Challenge” button on the right of the Challenge screen.
  ...
  /// Gems are a currency purchased with real money that allow you to buy extra content within Adhder and are one of the main sources of financial support for the Adhder team alongside subscriptions.\n\nAll content purchased through Gems is purely cosmetic or can be obtained for free with time.\n\nYou can also receive Gems through gifts from other players, Challenge prizes, contributing to Adhder, or subscribing.
  public static var gemsDescription: String { return L10n.tr("Mainstrings", "gems_description") }
  /// Purchasing Gems supports our small team and helps keep Adhder running
  public static var gemsSupportDevelopers: String { return L10n.tr("Mainstrings", "gems_support_developers") }
  /// Get more out of Adhder
  public static var getMoreAdhder: String { return L10n.tr("Mainstrings", "get_more_adhder") }
  /// Get Started
  public static var getStarted: String { return L10n.tr("Mainstrings", "get_started") }
  /// You sent %@ a %@-month Adhder subscription.
  ...
  /// You sent %@ a %@-month Adhder subscription and the same subscription was applied to your account for our Gift One Get One promotion!
  ...
  /// Adhder will never require you to gift gems to other players. Begging people for gems is a violation of the Community Guidelines and should be reported to admin@adhder.com.
  ...
  /// Gold is the **main form of currency** within Adhder and allows you to buy certain gear, quests, items, or even custom rewards you make for yourself.\n\n**Earn Gold** through completing tasks or quests, or through some Class skills. Higher **Perception stats** raise the amount of Gold you earn.\n\nIf you subscribe to Adhder, you can even use Gold to purchase a number of Gems determined by the length of time you’ve been subscribed.
  ...
  /// Ventured into the social side of Adhder by joining a Guild!
  ...
  /// Join Adhder
  public static var joinAdhder: String { return L10n.tr("Mainstrings", "join_adhder") }
  /// Joined Challenge
  ...
  /// I got to level %ld in Adhder by improving my real-life habits!
  ...
  /// You can [contact us](mailto:admin@adhder.com?subject=%%5BiOS%%5D%%20Question) and a member of our team will do their best to help!
  ...
  /// This is used to improve the player experience, performance, and services of Adhder. Our support team will also use this when handling requests and bug reports.
  ...
  /// Your privacy is important to us. Adhder uses data from your device to analyze performance, handle support requests, and provide you with the best possible gamified experience. To do that, we need to request the following permissions.\n\nYou can change these at any time from your account settings.
  ...
  /// Adhder uses data from your device to analyze performance, handle support requests, and provide you with the best possible gamified experience. To do that, we need to request the following permissions.\n\nYou can change this at any time. To learn more, review our [Privacy Policy](https://adhder.com/static/privacy).
  ...
  /// You should only report a %@ that violates the Community Guidelines and/or Terms of Service. Submitting a false report is a violation of Adhder’s Community Guidelines.
  ...
  /// Subscribing supports our small team and helps keep Adhder running
  ...
  /// Teleporting to Adhder
  public static var teleportingAdhder: String { return L10n.tr("Mainstrings", "teleporting_adhder") }
  /// Terms of Service
  ...
  public enum ChallengeCategory {
    ...
    /// Adhder Official
    public static var adhderOfficial: String { return L10n.tr("Mainstrings", "challenge_category.adhder_official") }
    /// Health + Fitness
  ...
  public enum Classes {
    ...
    /// Mages learn swiftly, gaining Experience and Levels faster than other classes. They also get a great deal of Mana for using special abilities. Play a Mage if you enjoy the tactical game aspects of Adhder, or if you are strongly motivated by leveling up and unlocking advanced features!
  ...
  public enum Empty {
    ...
    public enum Rewards {
      /// Rewards are a great way to use Adhder and complete your tasks. Try adding a few today!
  ...
  public enum Inventory {
    ...
    /// I just hatched a %@ %@ pet in Adhder by completing my real-life tasks!
  ...
  public enum Login {
    ...
    /// Enter the email address you used to register your Adhder account.
    ...
    /// You confirm that you are at least 18 years old, and that you have read and agree to our **[Terms of Service](https://adhder.com/static/terms)** and **[Privacy Policy](https://adhder.com/static/privacy)**.
  ...
  public enum WorldBoss {
    /// Defeat the Boss to earn special rewards and save Adhder from %@'s Terror!
    ...
    /// There are 3 potential Rage Strikes\nThis gauge fills when Adhderns miss their Dailies. If it fills up, the DysHeartener will unleash its Shattering Heartbreak attack on one of Adhder's shopkeepers, so be sure to do your tasks!
