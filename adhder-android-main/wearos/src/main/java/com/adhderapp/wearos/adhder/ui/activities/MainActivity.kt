...
import com.adhderapp.wearos.adhder.ui.adapters.HubAdapter
import com.adhderapp.wearos.adhder.ui.viewmodels.MainViewModel
...
class MainActivity : BaseActivity<ActivityMainBinding, MainViewModel>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.apply {
            layoutManager =
                WearableLinearLayoutManager(this@MainActivity, AdhderScrollingLayoutCallback())
