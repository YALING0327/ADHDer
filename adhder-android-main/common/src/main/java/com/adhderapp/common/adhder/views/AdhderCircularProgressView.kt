...
@Composable
fun AdhderCircularProgressView(
...
private fun Preview() {
    Column(
        ...
        AdhderCircularProgressView(indicatorSize = 40.dp, strokeWidth = 5.dp)
        AdhderCircularProgressView(partialDisplay = 0.3f, indicatorSize = 32.dp, strokeWidth = 4.dp)
        AdhderCircularProgressView(partialDisplay = 0.91f, indicatorSize = 32.dp, strokeWidth = 4.dp)
    }
}
