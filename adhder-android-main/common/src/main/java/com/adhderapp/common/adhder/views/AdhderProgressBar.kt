...
import com.adhderapp.common.adhder.databinding.ProgressBarBinding
    ...
    init {
        ...
        val attributes =
            context.theme?.obtainStyledAttributes(
                attrs,
                R.styleable.AdhderProgressBar,
                0,
                0
            )

        barForegroundColor = attributes?.getColor(R.styleable.AdhderProgressBar_barForegroundColor, 0) ?: 0
        barPendingColor = attributes?.getColor(R.styleable.AdhderProgressBar_barPendingColor, 0) ?: 0
        barBackgroundColor = attributes?.getColor(R.styleable.AdhderProgressBar_barBackgroundColor, 0) ?: 0
    }
