package com.adhderapp.common.adhder.api
    ...
    constructor(sharedPreferences: SharedPreferences, keyHelper: KeyHelper?, context: Context) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            if (!address.isNullOrEmpty()) {
                ...
                this.address = context.getString(com.adhderapp.common.adhder.R.string.base_url)
            }
        }
        this.userID = sharedPreferences.getString(context.getString(com.adhderapp.common.adhder.R.string.SP_userID), null) ?: ""
