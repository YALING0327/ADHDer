...
class StarView : AppCompatImageView {
    ...
    fun setStarSize(size: Int) {
        when (size) {
            0 -> {
                this.setImageBitmap(AdhderIconsHelper.imageOfStarSmall())
            }

            1 -> {
                this.setImageBitmap(AdhderIconsHelper.imageOfStarMedium())
            }

            2 -> {
                this.setImageBitmap(AdhderIconsHelper.imageOfStarLarge())
            }
        }
    }
