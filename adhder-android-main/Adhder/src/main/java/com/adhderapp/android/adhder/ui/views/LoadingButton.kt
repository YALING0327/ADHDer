...
fun LoadingButton(
    ...
    val colorStyle =
        if (type == LoadingButtonType.DESTRUCTIVE) {
            ButtonDefaults.buttonColors(
                containerColor = AdhderTheme.colors.errorBackground,
                contentColor = Color.White,
                disabledContainerColor = AdhderTheme.colors.offsetBackground,
                disabledContentColor = AdhderTheme.colors.textQuad
            )
        } else {
            ButtonDefaults.buttonColors(
                containerColor = AdhderTheme.colors.tintedUiSub,
                contentColor = Color.White,
                disabledContainerColor = AdhderTheme.colors.offsetBackground,
                disabledContentColor = AdhderTheme.colors.textQuad
            )
    ...
    val backgroundColor =
        animateColorAsState(
            targetValue =
            when (state) {
                LoadingButtonState.FAILED -> AdhderTheme.colors.errorBackground
    ...
    val contentColor =
        animateColorAsState(
            ...
            when (state) {
                ...
                LoadingButtonState.SUCCESS -> if (type == LoadingButtonType.DESTRUCTIVE) AdhderTheme.colors.errorColor else AdhderTheme.colors.successColor
    ...
    Button(
        ...
        if (state == LoadingButtonState.SUCCESS) {
            BorderStroke(
                borderWidth.value,
                if (type == LoadingButtonType.DESTRUCTIVE) AdhderTheme.colors.errorColor else AdhderTheme.colors.successColor
            )
        } else {
            border
        },
...
private fun Preview() {
    ...
    Column(
        ...
        LoadingButton(
            ...
            colors =
            ButtonDefaults.buttonColors(
                containerColor = AdhderTheme.colors.successBackground,
                contentColor = Color.White
            ),
            content = {
                Text("Do something")
