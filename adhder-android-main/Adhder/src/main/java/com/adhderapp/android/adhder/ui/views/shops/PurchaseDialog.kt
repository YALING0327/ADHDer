...
import com.adhderapp.android.adhder.databinding.DialogPurchaseShopitemButtonBinding
import com.adhderapp.android.adhder.databinding.DialogPurchaseShopitemHeaderBinding
...
import com.adhderapp.android.adhder.extensions.getShortRemainingString
...
import com.adhderapp.android.adhder.helpers.HapticFeedbackManager
...
import com.adhderapp.android.adhder.ui.activities.ArmoireActivityDirections
import com.adhderapp.android.adhder.ui.fragments.purchases.EventOutcomeSubscriptionBottomSheetFragment
import com.adhderapp.android.adhder.ui.fragments.purchases.SubscriptionBottomSheetFragment
import com.adhderapp.android.adhder.ui.views.CurrencyView
import com.adhderapp.android.adhder.ui.views.CurrencyViews
...
import com.adhderapp.android.adhder.ui.views.getTranslatedClassNamePlural
import com.adhderapp.android.adhder.ui.views.insufficientCurrency.InsufficientGemsDialog
import com.adhderapp.android.adhder.ui.views.insufficientCurrency.InsufficientGoldDialog
import com.adhderapp.android.adhder.ui.views.insufficientCurrency.InsufficientHourglassesDialog
import com.adhderapp.android.adhder.ui.views.insufficientCurrency.InsufficientSubscriberGemsDialog
import com.adhderapp.android.adhder.ui.views.tasks.form.StepperValueFormView
...
class PurchaseDialog(
    ...
    private fun findSnackBarActivity(context: Context): SnackbarActivity? {
        return when (context) {
            ...
            else -> (context.applicationContext as? AdhderBaseApplication)?.currentActivity?.get() as? SnackbarActivity
        }
    }
    ...
    var isPinned: Boolean = false
        set(value) {
            field = value
            if (isPinned) {
                pinIcon.setImageDrawable(BitmapDrawable(context.resources, AdhderIconsHelper.imageOfUnpinItem()))
                ...
                pinIcon.setImageDrawable(BitmapDrawable(context.resources, AdhderIconsHelper.imageOfPinItem()))
    ...
    private suspend fun showPurchaseSuccess(snackbarText: Array<String>) {
        val application = ownerActivity?.application as? AdhderBaseApplication
    ...
    private fun displaySomeRemainingConfirmationDialog(quantity: Int) {
        val alert = AdhderAlertDialog(context)
