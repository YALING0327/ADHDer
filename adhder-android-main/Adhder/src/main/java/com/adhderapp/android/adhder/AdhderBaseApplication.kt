...
import com.adhderapp.android.adhder.helpers.notifications.PushNotificationManager.Companion.DEVICE_TOKEN_PREFERENCE_KEY
...
import com.adhderapp.android.adhder.ui.activities.OnboardingActivity
...
@HiltAndroidApp
abstract class AdhderBaseApplication : Application(), Application.ActivityLifecycleCallbacks {
    @Inject
    ...
    companion object {
        fun getInstance(context: Context): AdhderBaseApplication? {
            return context.applicationContext as? AdhderBaseApplication
        }
