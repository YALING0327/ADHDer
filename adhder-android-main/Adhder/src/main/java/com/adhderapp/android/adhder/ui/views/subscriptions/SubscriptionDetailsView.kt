package com.adhderapp.android.adhder.ui.views.subscriptions
...
import com.adhderapp.android.adhder.databinding.SubscriptionDetailsBinding
import com.adhderapp.android.adhder.extensions.toZonedDateTime
...
class SubscriptionDetailsView : LinearLayout {
    ...
    private fun setupView() {
        ...
        binding.heartIcon.setImageBitmap(AdhderIconsHelper.imageOfHeartLarge())
    }
        ...
        if (plan.paymentMethod != null) {
            ...
            if (plan.paymentMethod == "Google") {
                ...
                if (plan.isGroupPlanSub) {
                    ...
                    binding.changeSubscriptionButton.setText(R.string.open_adhder_website)
                    binding.changeSubscriptionButton.visibility = View.VISIBLE
                }
            }
        }
