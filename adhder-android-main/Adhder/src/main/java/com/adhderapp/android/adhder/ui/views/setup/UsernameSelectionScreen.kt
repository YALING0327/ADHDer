package com.adhderapp.android.adhder.ui.views.setup
...
import com.adhderapp.android.adhder.ui.views.LoginFieldState
import com.adhderapp.android.adhder.ui.views.LoginScreenField
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .background(colorResource(R.color.brand_100), shape = AdhderTheme.shapes.small)) {
                    if (acceptedTerms) {
                        Image(
            ...
            Button(
                ...
                shape = AdhderTheme.shapes.large,
