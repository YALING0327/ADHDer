package com.adhderapp.android.adhder.ui.adapter
...
import com.adhderapp.android.adhder.ui.viewHolders.ComposableViewHolder
import com.adhderapp.android.adhder.ui.views.promo.BirthdayBanner
import com.adhderapp.android.adhder.ui.views.promo.PromoMenuView
import com.adhderapp.android.adhder.ui.views.promo.PromoMenuViewHolder
import com.adhderapp.android.adhder.ui.views.promo.SubscriptionBuyGemsPromoView
import com.adhderapp.android.adhder.ui.views.promo.SubscriptionBuyGemsPromoViewHolder
...
class NavigationDrawerAdapter(tintColor: Int, backgroundTintColor: Int) :
    ...
    internal val items: MutableList<AdhderDrawerItem> = ArrayList()
    ...
    var itemSelectedEvents: ((AdhderDrawerItem) -> Unit)? = null
    var promoClosedSubject: ((String) -> Unit)? = null

    var activePromo: AdhderPromotion? = null
    var currentEvent: WorldStateEvent? = null

    fun getItemWithIdentifier(identifier: String): AdhderDrawerItem? =
    ...
    fun updateItem(item: AdhderDrawerItem) {
        val position = getItemPosition(item.identifier)
        items[position] = item
        notifyDataSetChanged()
    }

    fun updateItems(newItems: List<AdhderDrawerItem>) {
        items.clear()
    ...
    class SectionHeaderViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(drawerItem: AdhderDrawerItem) {
