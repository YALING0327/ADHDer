...
import com.adhderapp.android.adhder.databinding.ActivityTaskFormBinding
import com.adhderapp.android.adhder.extensions.OnChangeTextWatcher
...
import com.adhderapp.android.adhder.models.tasks.RemindersItem
import com.adhderapp.android.adhder.models.tasks.Task
import com.adhderapp.android.adhder.models.tasks.TaskGroupPlan
import com.adhderapp.android.adhder.ui.helpers.ToolbarColorHelper
import com.adhderapp.android.adhder.ui.helpers.dismissKeyboard
import com.adhderapp.android.adhder.ui.theme.colors
import com.adhderapp.android.adhder.ui.theme.textPrimaryFor
import com.adhderapp.android.adhder.ui.theme.windowBackgroundFor
import com.adhderapp.android.adhder.ui.viewmodels.MainUserViewModel
import com.adhderapp.android.adhder.ui.viewmodels.TaskFormViewModel
...
import com.adhderapp.android.adhder.ui.views.tasks.AssignSheet
import com.adhderapp.android.adhder.ui.views.tasks.AssignedView
import com.adhderapp.android.adhder.ui.views.tasks.form.HabitScoringSelector
import com.adhderapp.android.adhder.ui.views.tasks.form.LabeledValue
import com.adhderapp.android.adhder.ui.views.tasks.form.TaskDifficultySelector
import com.adhderapp.android.adhder.ui.views.tasks.form.TaskFormSelector
...
class TaskFormActivity : BaseActivity() {
    ...
    private val notificationPermissionLauncher =
        registerForActivityResult(
            ...
            if (granted) {
                ...
                val alert = AdhderAlertDialog(this)
            ...
            binding.assignView.setContent {
                AdhderTheme {
                    AssignedView(
                        ...
                        taskCompletedMap,
                        AdhderTheme.colors.windowBackgroundFor(task),
                        AdhderTheme.colors.textPrimaryFor(task),
                        {
                            showAssignDialog()
                        },
                        {
    ...
    private fun showChallengeDeleteTask() {
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            val alert = AdhderAlertDialog(this@TaskFormActivity)
        ...
        lifecycleScope.launch(Dispatchers.Main) {
            val tasks =
                taskRepository.getTasksForChallenge(task.challengeID).firstOrNull()
                    ?: return@launch
            val taskCount = tasks.size
            val dialog = AdhderAlertDialog(this@TaskFormActivity)
