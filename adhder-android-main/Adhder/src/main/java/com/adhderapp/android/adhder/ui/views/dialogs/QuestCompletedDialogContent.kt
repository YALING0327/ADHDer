...
import com.adhderapp.android.adhder.databinding.DialogCompletedQuestContentBinding
    ...
    fun setQuestContent(questContent: QuestContent) {
        ...
        if (questContent.drop != null && questContent.drop?.items != null) {
            ...
            if ((questContent.drop?.exp ?: 0) > 0) {
                ...
                imageView?.setImageBitmap(AdhderIconsHelper.imageOfExperienceReward())
            ...
            if ((questContent.drop?.gp ?: 0) > 0) {
                ...
                val imageView = view?.findViewById<ImageView>(R.id.imageView)
                imageView?.scaleType = ImageView.ScaleType.CENTER
                imageView?.setImageBitmap(AdhderIconsHelper.imageOfGoldReward())
                val titleTextView = view?.findViewById<TextView>(R.id.titleTextView)
