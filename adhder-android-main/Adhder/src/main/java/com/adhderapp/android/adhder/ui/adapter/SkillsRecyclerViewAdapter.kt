...
import com.adhderapp.android.adhder.databinding.SkillListItemBinding
import com.adhderapp.android.adhder.databinding.SkillTransformationListItemBinding
...
class SkillsRecyclerViewAdapter :
    ...
    private inner class NormalViewHolder(itemView: View) :
        ...
        private val magicDrawable: Drawable =
            BitmapDrawable(context.resources, AdhderIconsHelper.imageOfMagic())
