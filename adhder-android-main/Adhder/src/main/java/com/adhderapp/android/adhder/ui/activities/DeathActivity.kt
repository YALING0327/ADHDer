...
import com.adhderapp.android.adhder.databinding.ActivityDeathBinding
import com.adhderapp.android.adhder.extensions.DateUtils
...
import com.adhderapp.android.adhder.helpers.AdHandler
import com.adhderapp.android.adhder.helpers.AdType
...
import com.adhderapp.android.adhder.ui.views.ads.AdButton
            ...
            lifecycleScope.launch(ExceptionHandler.coroutine()) {
                ...
                if (brokenItem != null) {
                    MainScope().launchCatching {
                        delay(500)
                        (AdhderBaseApplication.getInstance(this@DeathActivity)?.currentActivity?.get() as? SnackbarActivity)?.let { activity ->
                            AdhderSnackbar.showSnackbar(
                                activity.snackbarContainer(),
                                getString(R.string.revive_broken_equipment, brokenItem.text),
                                AdhderSnackbar.SnackbarDisplayType.BLACK
                            )
                        }
                    }
                }
            ...
            MainScope().launchCatching {
                ...
                (AdhderBaseApplication.getInstance(this@DeathActivity)?.currentActivity?.get() as? SnackbarActivity)?.let { activity ->
                    AdhderSnackbar.showSnackbar(
                        ...
                        AdhderSnackbar.SnackbarDisplayType.SUBSCRIBER_BENEFIT,
