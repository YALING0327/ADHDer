...
import com.adhderapp.android.adhder.databinding.PartyMemberBinding
...
class GroupMemberViewHolder(itemView: View) :
    ...
    init {
        binding.buffIconView.setImageBitmap(AdhderIconsHelper.imageOfBuffIcon())
    ...
    fun bind(
        ...
        when (user.stats?.habitClass) {
            Stats.HEALER -> {
                binding.classIconView.setImageBitmap(AdhderIconsHelper.imageOfHealerLightBg())
            }

            Stats.WARRIOR -> {
                binding.classIconView.setImageBitmap(AdhderIconsHelper.imageOfWarriorLightBg())
            }

            Stats.ROGUE -> {
                binding.classIconView.setImageBitmap(AdhderIconsHelper.imageOfRogueLightBg())
            }

            Stats.MAGE -> {
                binding.classIconView.setImageBitmap(AdhderIconsHelper.imageOfMageLightBg())
            }
