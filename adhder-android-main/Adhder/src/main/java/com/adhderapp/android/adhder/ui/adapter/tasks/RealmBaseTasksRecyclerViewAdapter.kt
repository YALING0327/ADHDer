...
import com.adhderapp.android.adhder.databinding.AdventureGuideMenuBannerBinding
...
import com.adhderapp.android.adhder.ui.adapter.DiffCallback
...
class AdventureGuideViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    init {
        itemView.findViewById<TextView>(R.id.gold_textview).setCompoundDrawablesWithIntrinsicBounds(
            BitmapDrawable(itemView.resources, AdhderIconsHelper.imageOfGold()),
            null,
            null,
            null
        )
