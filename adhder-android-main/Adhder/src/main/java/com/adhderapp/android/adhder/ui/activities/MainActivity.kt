...
import com.adhderapp.android.adhder.MainNavDirections
...
import com.adhderapp.android.adhder.databinding.ActivityMainBinding
import com.adhderapp.android.adhder.extensions.hideKeyboard
...
import com.adhderapp.android.adhder.helpers.CrashReporter
import com.adhderapp.android.adhder.helpers.EventCategory
import com.adhderapp.android.adhder.helpers.HitType
import com.adhderapp.android.adhder.helpers.NotificationOpenHandler
import com.adhderapp.android.adhder.helpers.ReviewManager
import com.adhderapp.android.adhder.helpers.SoundManager
import com.adhderapp.android.adhder.helpers.collectAsStateLifecycleAware
import com.adhderapp.android.adhder.interactors.CheckClassSelectionUseCase
import com.adhderapp.android.adhder.interactors.DisplayItemDropUseCase
import com.adhderapp.android.adhder.interactors.NotifyUserUseCase
import com.adhderapp.android.adhder.interactors.ShareAvatarUseCase
...
import com.adhderapp.android.adhder.ui.fragments.NavigationDrawerFragment
import com.adhderapp.android.adhder.ui.theme.colors
import com.adhderapp.android.adhder.ui.viewmodels.MainActivityViewModel
import com.adhderapp.android.adhder.ui.viewmodels.NotificationsViewModel
import com.adhderapp.android.adhder.ui.views.AppHeaderView
import com.adhderapp.android.adhder.ui.views.GroupPlanMemberList
import com.adhderapp.android.adhder.ui.views.AdhderButton
import com.adhderapp.android.adhder.ui.views.AdhderSnackbar
import com.adhderapp.android.adhder.ui.views.SnackbarActivity
import com.adhderapp.android.adhder.ui.views.dialogs.QuestCompletedDialog
import com.adhderapp.android.adhder.ui.views.showAsBottomSheet
import com.adhderapp.android.adhder.ui.views.yesterdailies.YesterdailyDialog
import com.adhderapp.android.adhder.widget.AvatarStatsWidgetProvider
import com.adhderapp.android.adhder.widget.DailiesWidgetProvider
import com.adhderapp.android.adhder.widget.HabitButtonWidgetProvider
import com.adhderapp.android.adhder.widget.TodoListWidgetProvider
...
import com.adhderapp.common.adhder.extensions.isUsingNightModeResources
import com.adhderapp.common.adhder.extensions.observeOnce
import com.adhderapp.common.adhder.extensions.setScaledPadding
...
import com.adhderapp.common.adhder.views.ComposableAvatarView
                            ...
                            Box(
                                ...
                                Column(
                                    ...
                                    Column(
                                        ...
                                        AdhderButton(
                                            background = AdhderTheme.colors.tintedUiSub,
                                            color = Color.White,
    ...
    override fun showConnectionProblem(
        ...
        if (errorCount == 1 && !isFromUserInput) {
            showSnackbar(
                title = title,
                content = message,
                displayType = AdhderSnackbar.SnackbarDisplayType.FAILURE
            )
        } else if (title != null) {
