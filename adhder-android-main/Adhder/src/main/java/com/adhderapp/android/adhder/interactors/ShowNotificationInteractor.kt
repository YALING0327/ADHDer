...
import com.adhderapp.android.adhder.ui.views.dialogs.AchievementDialog
import com.adhderapp.android.adhder.ui.views.dialogs.FirstDropDialog
import com.adhderapp.android.adhder.ui.views.dialogs.AdhderAlertDialog
import com.adhderapp.android.adhder.ui.views.dialogs.WonChallengeDialog
    ...
    fun showCheckinDialog(notification: Notification) {
        ...
        if (notificationData?.rewardKey != null) {
            ...
            lifecycleScope.launch(context = Dispatchers.Main) {
                ...
                val alert = AdhderAlertDialog(activity)
            ...
            (activity as? SnackbarActivity)?.showSnackbar(
                ...
                displayType = AdhderSnackbar.SnackbarDisplayType.BLUE
            )
        }
    }
