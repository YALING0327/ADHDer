...
import com.adhderapp.android.adhder.databinding.DialogHatchPetButtonBinding
import com.adhderapp.android.adhder.databinding.DialogPetSuggestHatchBinding
...
class PetSuggestHatchDialog(context: Context) : AdhderAlertDialog(context) {
    @EntryPoint
                ...
                addButton(binding.root, true) { _, _ ->
                    val activity =
                        (getActivity() as? MainActivity) ?: (
                            AdhderBaseApplication.getInstance(
                                context
