...
import com.adhderapp.android.adhder.databinding.RowShopitemBinding
import com.adhderapp.android.adhder.extensions.getImpreciseRemainingString
...
class ShopItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
    ...
    init {
        ...
        binding.pinIndicator.setImageBitmap(AdhderIconsHelper.imageOfPinnedItem())
    }
