package com.adhderapp.android.adhder.ui.fragments.tasks
...
import com.adhderapp.android.adhder.databinding.FragmentRefreshRecyclerviewBinding
import com.adhderapp.android.adhder.databinding.FragmentTasksRecyclerviewBinding
...
import com.adhderapp.android.adhder.ui.activities.TaskFormActivity
import com.adhderapp.android.adhder.ui.adapter.BaseRecyclerViewAdapter
import com.adhderapp.android.adhder.ui.adapter.tasks.DailiesRecyclerViewHolder
import com.adhderapp.android.adhder.ui.adapter.tasks.HabitsRecyclerViewAdapter
import com.adhderapp.android.adhder.ui.adapter.tasks.RewardsRecyclerViewAdapter
import com.adhderapp.android.adhder.ui.adapter.tasks.TaskRecyclerViewAdapter
import com.adhderapp.android.adhder.ui.adapter.tasks.TodosRecyclerViewAdapter
...
import com.adhderapp.android.adhder.ui.viewHolders.tasks.BaseTaskViewHolder
        ...
        if (taskType == TaskType.REWARD) {
            (activity as? MainActivity)?.let { activity ->
                AdhderSnackbar.showSnackbar(
                    ...
                    BitmapDrawable(resources, AdhderIconsHelper.imageOfGold()),
    ...
    protected fun showBrokenChallengeDialog(task: Task) {
        context?.let {
            ...
            lifecycleScope.launchCatching {
                ...
                val dialog = AdhderAlertDialog(it)
