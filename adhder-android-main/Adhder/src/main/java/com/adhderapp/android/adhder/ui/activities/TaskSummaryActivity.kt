...
import com.adhderapp.android.adhder.helpers.TaskDescriptionBuilder
import com.adhderapp.android.adhder.models.members.Member
import com.adhderapp.android.adhder.ui.activities.TaskFormActivity.Companion.TASK_VALUE_KEY
import com.adhderapp.android.adhder.ui.theme.colors
import com.adhderapp.android.adhder.ui.theme.contentBackgroundFor
import com.adhderapp.android.adhder.ui.theme.primaryBackgroundFor
import com.adhderapp.android.adhder.ui.theme.textPrimaryFor
import com.adhderapp.android.adhder.ui.theme.textSecondaryFor
...
import com.adhderapp.android.adhder.ui.views.CompletedAt
import com.adhderapp.android.adhder.ui.views.AdhderIconsHelper
import com.adhderapp.android.adhder.ui.views.UserRow
...
fun TaskSummaryView(viewModel: TaskSummaryViewModel) {
    ...
    if (task != null) {
        val darkestColor = AdhderTheme.colors.textPrimaryFor(task)
        val topTextColor =
        ...
        Column(Modifier.background(AdhderTheme.colors.primaryBackgroundFor(task))) {
            ...
            Column(
                Modifier
                    .shadow(16.dp)
                    .background(
                        AdhderTheme.colors.contentBackgroundFor(task),
                ...
                if (task?.type == TaskType.REWARD) {
                    ...
                    Row(
                        ...
                        Image(AdhderIconsHelper.imageOfGold().asImageBitmap(), null)
                        Text(
                            "${task?.value}",
                            fontSize = 16.sp,
                            fontWeight = FontWeight.Medium,
                ...
                if (task?.group?.assignedUsersDetail?.isNotEmpty() == true) {
                    ...
                    task?.group?.assignedDetailsFor(viewModel.userViewModel.userID)?.let {
                        ...
                        Text(
                            ...
                            fontSize = 14.sp,
                            color = AdhderTheme.colors.textSecondaryFor(task),
