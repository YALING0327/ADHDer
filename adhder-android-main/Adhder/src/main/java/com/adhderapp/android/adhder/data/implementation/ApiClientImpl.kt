...
import com.adhderapp.android.adhder.api.ApiService
import com.adhderapp.android.adhder.api.GSonFactoryCreator
...
import com.adhderapp.android.adhder.models.LeaveChallengeBody
...
import com.adhderapp.android.adhder.models.responses.BulkTaskScoringData
import com.adhderapp.android.adhder.models.responses.BuyResponse
import com.adhderapp.android.adhder.models.responses.PostChatMessageResult
...
import com.adhderapp.common.adhder.api.Server
import com.adhderapp.common.adhder.models.HabitResponse
import com.adhderapp.common.adhder.models.PurchaseValidationRequest
import com.adhderapp.common.adhder.models.PurchaseValidationResult
import com.adhderapp.common.adhder.models.auth.UserAuth
import com.adhderapp.common.adhder.models.auth.UserAuthResponse
import com.adhderapp.common.adhder.models.auth.UserAuthSocial
import com.adhderapp.common.adhder.models.auth.UserAuthSocialTokens
import com.adhderapp.shared.adhder.models.responses.ErrorResponse
import com.adhderapp.shared.adhder.models.responses.FeedResponse
import com.adhderapp.shared.adhder.models.responses.Status
...
class ApiClientImpl(
        ...
        val client =
            OkHttpClient.Builder()
                ...
                .addNetworkInterceptor { chain ->
                    ...
                    builder =
                        builder.header("x-client", "adhder-android")
                            ...
                            when (response.code) {
                                401 -> {
                                    ...
                                    if (!path.contains("/user/auth/update-password") && !path.contains("group-plans")) {
                                        ...
                                        if (shouldLogout) {
                                            AdhderBaseApplication.logout(context)
                                        }
                                    }
                                    return@addNetworkInterceptor response
                                }
    ...
    private fun showConnectionProblemDialog(
        ...
        val application =
            (context as? AdhderBaseApplication)
                ?: (context.applicationContext as? AdhderBaseApplication)
