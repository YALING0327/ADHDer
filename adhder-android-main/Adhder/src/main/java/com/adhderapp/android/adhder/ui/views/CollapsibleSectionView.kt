...
import com.adhderapp.android.adhder.databinding.ViewCollapsibleSectionBinding
...
class CollapsibleSectionView(context: Context, attrs: AttributeSet?) :
    ...
    private fun setCaretImage() {
        binding.caretView.setImageBitmap(AdhderIconsHelper.imageOfCaret(caretColor, isCollapsed))
    }
