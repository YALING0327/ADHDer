package com.adhderapp.android.adhder.ui.views.navigation
...
import com.adhderapp.android.adhder.databinding.MainNavigationViewBinding
...
interface AdhderBottomNavigationViewListener {
    fun onTabSelected(
        taskType: TaskType,
        smooth: Boolean
    )
...
class AdhderBottomNavigationView
@JvmOverloads
constructor(
    context: Context,
    ...
    var listener: AdhderBottomNavigationViewListener? = null
