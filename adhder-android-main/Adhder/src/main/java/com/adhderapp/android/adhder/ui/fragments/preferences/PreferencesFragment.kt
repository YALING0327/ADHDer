...
import com.adhderapp.android.adhder.prefs.TimePreference
import com.adhderapp.android.adhder.ui.activities.ClassSelectionActivity
import com.adhderapp.android.adhder.ui.activities.MainActivity
import com.adhderapp.android.adhder.ui.activities.PrefsActivity
...
import com.adhderapp.android.adhder.ui.views.preferences.PauseResumeDamageView
...
class PreferencesFragment :
    ...
    override fun onPreferenceTreeClick(preference: Preference): Boolean {
        when (preference.key) {
            ...
            "clear_database" -> {
                context?.let { context ->
                    AdhderBaseApplication.deleteDatabase(context)
                    lifecycleScope.launchCatching {
                        userRepository.retrieveUser(true, true)
                        (activity as? SnackbarActivity)?.showSnackbar(
    ...
    private fun logout() {
        context?.let { context ->
            ...
            dialog.addButton(R.string.logout, true) { _, _ ->
                AdhderBaseApplication.logout(context, user)
                activity?.finish()
            }
