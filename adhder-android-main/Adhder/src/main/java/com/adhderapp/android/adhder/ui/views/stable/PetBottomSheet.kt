...
import com.adhderapp.android.adhder.interactors.SharePetUseCase
...
fun PetBottomSheet(
    ...
    Column(
        ...
        Text(
            ...
            color = AdhderTheme.colors.textTertiary
        )
        Box(
            modifier =
            Modifier
            ...
            this@Column.AnimatedVisibility(
                ...
                Text(
                    ...
                    Modifier
                        ...
                        .background(
                            AdhderTheme.colors.windowBackground,
                            AdhderTheme.shapes.medium
                        )
                        .padding(8.dp, 3.dp)
                        .alpha(0.65f)
                )
            ...
            this@Column.AnimatedVisibility(
                ...
                LinearProgressIndicator(
                    ...
                    color = AdhderTheme.colors.successColor,
        ...
        if (canRaiseToMount) {
            Row(
                ...
                AdhderButton(
                    ...
                    AdhderTheme.colors.textPrimary,
                    onClick = {
                        if (ownsSaddles) {
                            val saddle = Food()
                            saddle.key = "Saddle"
