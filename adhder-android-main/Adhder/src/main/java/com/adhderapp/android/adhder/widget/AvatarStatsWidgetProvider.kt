...
import com.adhderapp.common.adhder.helpers.HealthFormatter
    ...
    private fun updateData(widgetIds: IntArray? = null) {
        ...
        for (widgetId in allWidgetIds) {
            ...
            remoteViews.setImageViewBitmap(
                R.id.ic_hp_header,
                AdhderIconsHelper.imageOfHeartLightBg()
            )
            remoteViews.setImageViewBitmap(
                R.id.ic_exp_header,
                AdhderIconsHelper.imageOfExperience()
            )
            remoteViews.setImageViewBitmap(R.id.ic_mp_header, AdhderIconsHelper.imageOfMagic())
            ...
            if (hourGlassCount == 0) {
                ...
                remoteViews.setImageViewBitmap(
                    R.id.hourglass_icon,
                    AdhderIconsHelper.imageOfHourglass()
                )
            ...
            remoteViews.setImageViewBitmap(R.id.gem_icon, AdhderIconsHelper.imageOfGem())
            remoteViews.setImageViewBitmap(R.id.gold_icon, AdhderIconsHelper.imageOfGold())
            remoteViews.setTextViewText(
                R.id.lvl_tv,
