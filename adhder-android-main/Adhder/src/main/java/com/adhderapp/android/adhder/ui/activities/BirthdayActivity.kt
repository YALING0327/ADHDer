                ...
                BirthdayActivityView(
                    ...
                    },
                    {
                        lifecycleScope.launchCatching({
                            ...
                            isPurchasing.value = true
                            val dialog = AdhderAlertDialog(this@BirthdayActivity)
                            dialog.setTitle(
                                getString(
...
fun FourFreeItem(
    ...
    Column(
        ...
        modifier =
            modifier
                .background(colorResource(R.color.brand_50), AdhderTheme.shapes.medium)
                .padding(16.dp)
    ) {
        Text(
        ...
        Box(
            ...
            modifier =
                Modifier
                    .size(121.dp, 84.dp)
                    .background(colorResource(R.color.brand_100), AdhderTheme.shapes.medium)
        ) {
            if (image != null) {
                Image(image, null)
            } else {
