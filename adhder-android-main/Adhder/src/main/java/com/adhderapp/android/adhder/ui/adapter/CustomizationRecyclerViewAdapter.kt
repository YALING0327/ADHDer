...
import com.adhderapp.android.adhder.databinding.CustomizationGridItemBinding
import com.adhderapp.android.adhder.databinding.CustomizationSectionFooterBinding
import com.adhderapp.android.adhder.databinding.CustomizationSectionHeaderBinding
import com.adhderapp.android.adhder.models.inventory.Customization
import com.adhderapp.android.adhder.models.inventory.CustomizationSet
    ...
    internal inner class CustomizationViewHolder(itemView: View) :
        ...
        override fun onClick(v: View) {
            ...
            if (customization?.isUsable(ownedCustomizations.contains(customization?.id)) == false) {
                if (customization?.customizationSet?.contains("timeTravel") == true) {
                    val dialog = AdhderAlertDialog(itemView.context)
            ...
            if (customization?.type == "background") {
                val alert = AdhderAlertDialog(context = itemView.context)
