...
import com.adhderapp.android.adhder.databinding.MenuBottomSheetBinding
...
class BottomSheetMenu(context: Context) : AdhderBottomSheetDialog(context), View.OnClickListener {
