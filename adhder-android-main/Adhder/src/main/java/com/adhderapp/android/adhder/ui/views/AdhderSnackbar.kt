...
import com.adhderapp.android.adhder.databinding.SnackbarViewBinding
import com.adhderapp.common.adhder.helpers.Animations
import com.plattysoft.leonids.ParticleSystem

class AdhderSnackbar
/**
...
private constructor(parent: ViewGroup, content: View, callback: ContentViewCallback) :
    ...
    fun setLeftIcon(image: Drawable?): AdhderSnackbar {
    ...
    fun setBackgroundResource(resourceId: Int): AdhderSnackbar {
        binding.snackbarView.setBackgroundResource(resourceId)
        view.setBackgroundColor(ContextCompat.getColor(context, R.color.transparent))
        return this
    }

    private fun setSpecialView(specialView: View?): AdhderSnackbar {
        if (specialView != null) {
    ...
    companion object {
        ...
        private fun make(
            ...
            val customSnackbar = AdhderSnackbar(parent, content, viewCallback)
...
interface SnackbarActivity {
    ...
    fun showSnackbar(
        ...
        displayType: AdhderSnackbar.SnackbarDisplayType = AdhderSnackbar.SnackbarDisplayType.NORMAL,
        isCelebratory: Boolean = false
    ) {
