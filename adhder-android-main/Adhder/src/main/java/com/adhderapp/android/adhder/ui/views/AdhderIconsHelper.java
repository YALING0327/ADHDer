...
public class AdhderIconsHelper {
    ...
    public static Bitmap imageOfExperience() {
        ...
        AdhderIcons.drawExperience(canvas);
    ...
    public static Bitmap imageOfMagicLarge() {
        ...
        AdhderIcons.drawMagic(canvas, new RectF(0f, 0f, size, size), AdhderIcons.ResizingBehavior.AspectFit);
    ...
    public static Bitmap imageOfHourglass() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawHourglass(canvas);
    ...
    public static Bitmap imageOfHourglassLarge() {
        ...
        AdhderIcons.drawHourglass(canvas, new RectF(0f, 0f, size, size), AdhderIcons.ResizingBehavior.AspectFit);
    ...
    public static Bitmap imageOfExperienceReward() {
        ...
        AdhderIcons.drawExperience(canvas, new RectF(0f, 0f, size, size), AdhderIcons.ResizingBehavior.AspectFit);
    ...
    public static Bitmap imageOfGoldReward() {
        ...
        AdhderIcons.drawGold(canvas, new RectF(0f, 0f, size, size), AdhderIcons.ResizingBehavior.AspectFit);
    ...
    public static Bitmap imageOfHeartDarkBg() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawHeart(canvas, true);
    ...
    public static Bitmap imageOfHeartLightBg() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawHeart(canvas, false);
    ...
    public static Bitmap imageOfHeartLarge() {
        ...
        AdhderIcons.drawHeart(canvas, new RectF(0f, 0f, size, size), AdhderIcons.ResizingBehavior.AspectFit, false);
    ...
    public static Bitmap imageOfStarSmall() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawStarSmall(canvas);
    ...
    public static Bitmap imageOfStarLarge() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawStarLarge(canvas);
    ...
    public static Bitmap imageOfStarMedium() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawStarMedium(canvas);
    ...
    public static Bitmap imageOfPinnedItem() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawPinnedItem(canvas);
    ...
    public static Bitmap imageOfPinItem() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawAddRemovePin(canvas, true);
    ...
    public static Bitmap imageOfUnpinItem() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawAddRemovePin(canvas, false);
    ...
    public static Bitmap imageOfWarriorLightBg() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawWarriorLightBg(canvas);
    ...
    public static Bitmap imageOfRogueLightBg() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawRogueLightBg(canvas);
    ...
    public static Bitmap imageOfHealerLightBg() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawHealerLightBg(canvas);
    ...
    public static Bitmap imageOfMageLightBg() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawMageLightBg(canvas);
    ...
    public static Bitmap imageOfHourglassShop() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawHourglassShop(canvas);
    ...
    public static Bitmap imageOfAttributeSparklesLeft() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawAttributeSparklesLeft(canvas);
    ...
    public static Bitmap imageOfAttributeSparklesRight() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawAttributeSparklesRight(canvas);
    ...
    public static Bitmap imageOfAttributeAllocateButton() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawAttributeAllocateButton(canvas);
    ...
    public static Bitmap imageOfInfoIcon(@ColorInt int iconColor) {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawInfoIcon(canvas, iconColor);
    ...
    public static Bitmap imageOfContributorBadge(float contributorTier, boolean isNPC) {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawContributorBadge(canvas, contributorTier, isNPC);
    ...
    public static Bitmap imageOfCaret(int caretColor, boolean pointsUp) {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawCaret(canvas, caretColor, pointsUp);
    ...
    public static Bitmap imageOfLocked(@ColorInt int lockColor, int width, int height) {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawLocked(canvas, new RectF(0f, 0f, width, height), AdhderIcons.ResizingBehavior.AspectFit, lockColor);
    ...
    public static Bitmap imageOfParticipantsIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawParticipantsIcon(canvas);
    ...
    public static Bitmap imageOfChatReplyIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawChatReplyIcon(canvas);
    ...
    public static Bitmap imageOfChatCopyIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawChatCopyIcon(canvas);
    ...
    public static Bitmap imageOfChatReportIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawChatReportIcon(canvas);
    ...
    public static Bitmap imageOfChatDeleteIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawChatDeleteIcon(canvas);
    ...
    public static Bitmap imageOfTwoHandedIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawTwoHandedIcon(canvas);
    ...
    public static Bitmap imageOfCheckmark(int checkmarkColor, float percentage) {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawCheckmark(canvas, checkmarkColor, percentage);
    ...
    public static Bitmap imageOfAlertIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawAlertIcon(canvas);
    ...
    public static Bitmap imageOfBuffIcon() {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawBuffIcon(canvas);
    ...
    public static Bitmap imageOfTaskDifficultyStars(int taskTintColor, float difficulty, boolean isActive) {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawTaskDifficultyStars(canvas, taskTintColor, difficulty, isActive);
    ...
    public static Bitmap imageOfGuildCrestMedium(float memberCount) {
        ...
        canvas.scale(displayDensity, displayDensity);
        AdhderIcons.drawGuildCrestMedium(canvas, memberCount);
