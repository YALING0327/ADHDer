...
import com.adhderapp.android.adhder.ui.activities.PurchaseActivity
...
import com.adhderapp.common.adhder.models.IAPGift
import com.adhderapp.common.adhder.models.PurchaseValidationRequest
import com.adhderapp.common.adhder.models.Transaction
...
class PurchaseHandler(
        ...
        CoroutineScope(Dispatchers.Main).launchCatching {
            val application =
                (context as? AdhderBaseApplication)
                    ?: (context.applicationContext as? AdhderBaseApplication) ?: return@launchCatching
    ...
    private fun displayGryphatriceConfirmationDialog(
        ...
        MainScope().launch(ExceptionHandler.coroutine()) {
            val application =
                (context as? AdhderBaseApplication)
                    ?: (context.applicationContext as? AdhderBaseApplication) ?: return@launch
