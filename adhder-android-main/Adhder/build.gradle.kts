...
android {
    ...
    namespace = "com.adhder.android.adhder"

    defaultConfig {
        applicationId = "com.adhder.android.adhder"
    ...
    buildTypes {
        debug {
            ...
            resValue("string", "content_provider", "com.adhder.android.adhder.debug.fileprovider")
        ...
        create("debugIAP") {
            ...
            ext["enableCrashlytics"] = false
            ext["alwaysUpdateBuildId"] = false
            resValue("string", "content_provider", "com.adhder.android.adhder.fileprovider")
            resValue("string", "app_name", "Habitica Debug")
        }
        release {
            signingConfigs.asMap["release"]?.let { releaseSigning -> signingConfig = releaseSigning }
