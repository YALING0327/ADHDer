...
export default {
  ...
  ipAddressBlocked: 'Your connection to Adhder has been blocked. For additional information, or to request an appeal, email admin@adhder.com with your Adhder username or User ID.',
  clientBlocked: 'This client or third-party tool has been blocked. For additional information, email admin@adhder.com with your Adhder username or User ID.',
  clientRateLimited: 'This User ID or IP address has been rate limited due to an excess amount of requests to the Adhder API v3. More info can be found in the response headers and at https://github.com/AdhderApp/adhder/wiki/API-Usage-Guidelines#rate-limiting .',
