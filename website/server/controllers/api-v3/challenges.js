 ...
 *                                          this is an official Adhder challenge.
 *
 */
 ...
 *                                             Adhder challenge (requires admin).
...
api.getGroupChallenges = {
  ...
  async handler (req, res) {
    ...
    if (groupId === 'adhderapp') groupId = TAVERN_ID;
...
api.exportChallengeCsv = {
  ...
  async handler (req, res) {
    ...
    tasks.forEach(task => {
       ...
       * See more at https://github.com/AdhderApp/adhder/issues/8350
       */
