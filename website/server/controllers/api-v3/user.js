...
const OFFICIAL_PLATFORMS = ['adhder-web', 'adhder-ios', 'adhder-android'];
 ...
 * curl -i https://adhder.com/api/v3/user?userFields=achievements,items.mounts
 *
 ...
 *   --  https://github.com/AdhderApp/adhder/tree/develop/website/server/models/user
 *   }
 * }
 *
*/
 ...
 * https://adhder.com/api/v3/user/hatch/Dragon/CottonCandyPink
 *
 ...
 *
 * @apiParamExample {URL} Example-URL
 * https://adhder.com/api/v3/user/equip/equipped/weapon_warrior_2
 *
 * @apiSuccess {Object} data user.items
 ...
 *
 * @apiParamExample {url} Example-URL
 * https://adhder.com/api/v3/user/feed/Armadillo-Shade/Chocolate
 * https://adhder.com/api/v3/user/feed/Armadillo-Shade/Chocolate?amount=9
 *
 ...
 * curl -X POST https://adhder.com/api/v3/user/unlock?path=background.midnight_clouds
 * curl -X POST https://adhder.com/api/v3/user/unlock?path=hair.color.midnight
 *
