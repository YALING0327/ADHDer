 ...
 *
 * @apiSuccess {Object} data Various data about the content of Adhder. The content route
...
api.getContent = {
  ...
  async handler (req, res) {
    ...
    if (filter === '') {
      if (req.headers['x-client'] === 'adhder-android') {
        filter = ANDROID_FILTER;
      } else if (req.headers['x-client'] === 'adhder-ios') {
        filter = IOS_FILTER;
      }
    }
