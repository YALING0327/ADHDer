...
export const TaskSchema = new Schema({
  ...
  byAdhder: { $type: Boolean, default: false }, // Flag of Tasks that were created by Adhder
}, _.defaults({
  minimize: false, // So empty objects are returned
  strict: true,
  typeKey: '$type', // So that we can use fields named `type`
...
TaskSchema.plugin(baseModel, {
  ...
  sanitizeTransform (taskObj) {
    ...
    // See https://github.com/AdhderApp/adhder-ios/commit/4cd05f80363502eb7652e057aa564c85546f7806
...
// See https://adhder.fandom.com/wiki/Challenges#Challenge_Participant.27s_Permissions for more info
