...
export async function cron (options = {}) {
  ...
  // TODO also adjust tasksOrder arrays to remove deleted tasks of any kind (including rewards), ensure that all existing tasks are in the arrays, no tasks IDs are duplicated -- https://github.com/AdhderApp/adhder/issues/7645
