    ...
    <footer>
      ...
      <div class="product">
        ...
        <ul>
          <li>
            <a
              href="https://itunes.apple.com/us/app/adhder/id994882113?ls=1&mt=8"
              target="_blank"
            >{{ $t('mobileIOS') }}
            </a>
          </li>
          <li>
            <a
              href="https://play.google.com/store/apps/details?id=com.adhderapp.android.adhder"
              target="_blank"
            >{{ $t('mobileAndroid') }}
            </a>
          </li>
      ...
      <div class="company">
        ...
        <ul>
          <li>
            <a href="mailto:admin@adhder.com">
              {{ $t('contactUs') }}
            </a>
          </li>
          <li>
          ...
          <li>
            <a
              href="https://adhder.wordpress.com/"
              target="_blank"
            >{{ $t('companyBlog') }}
            </a>
          </li>
      ...
      <div class="community">
        ...
        <ul>
          ...
          <li>
            <a
              href="https://github.com/AdhderApp/adhder/wiki/Contributing-to-Adhder"
              target="_blank"
            >{{ $t('companyContribute') }}
            </a>
          </li>
          <li>
            <a
              href="https://translate.adhder.com/"
              target="_blank"
            >{{ $t('translateAdhder') }}
            </a>
          </li>
      ...
      <div class="support">
        ...
        <ul>
          ...
          >
            <a
              href="mailto:admin@adhder.com?subject=Adhder Web Bug Report"
              target="_blank"
            >
              {{ $t('reportBug') }}
            </a>
      ...
      <div class="developers">
        ...
        <ul>
          ...
          <li>
            <a
              href="https://adhder.fandom.com/wiki/Guidance_for_Blacksmiths"
              target="_blank"
      ...
      <div class="social">
        <div>
          ...
          <div class="icons">
            <a
              class="social-circle"
              href="https://www.instagram.com/adhder/"
              target="_blank"
            >
              <div
            ...
            <a
              class="social-circle"
              href="https://bsky.app/profile/adhder.com"
              target="_blank"
            >
              <div
            ...
            <a
              class="social-circle"
              href="https://www.facebook.com/Adhder/"
              target="_blank"
            >
              <div
      ...
      <div class=" copyright">
        <div>
          © {{ currentYear }} Adhder. All rights reserved.
        </div>
      </div>
      <div class="melior">
        <div
...
export default {
  ...
  computed: {
    ...
    getDataDisplayToolUrl () {
      const base = 'https://tools.adhder.com/';
