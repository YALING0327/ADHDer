    ...
    <div class="navbar-header">
      ...
      >
        <div
          ...
          class="adhder-logo svg-icon"
          v-html="icons.purpleLogo"
        ></div>
        <div
          v-else
          class="adhder-logo svg-icon"
          v-html="icons.adhderLogo"
        ></div>
      </router-link>
    </div>
...
<script>
import adhderLogo from '@/assets/svg/logo-horizontal.svg?raw';
