        ...
        <div class="row">
          ...
          @/assets/images/gems/spooky-header@3x.png 3x"
            ...
            <img
              ...
              :alt="$t('supportAdhder')"
              srcset="
          @/assets/images/gems/support-adhder.png,
          @/assets/images/gems/support-adhder@2x.png 2x,
          @/assets/images/gems/support-adhder@3x.png 3x"
              src="@/assets/images/gems/support-adhder.png"
            >
          </div>
        </div>
      </div>
