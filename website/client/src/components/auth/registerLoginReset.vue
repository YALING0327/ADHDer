    ...
    >
      <div class="text-center">
        <div>
          <a
            href="/static/home"
            class="svg-icon svg adhder-logo mx-auto mb-4"
            v-html="icons.adhderIcon"
          ></a>
        </div>
      </div>
    ...
    >
      <div>
        <div>
          <a
            href="/static/home"
            class="svg-icon adhder-logo mx-auto mb-4"
            v-html="icons.adhderIcon"
          ></a>
        </div>
        <div class="header">
...
import adhderIcon from '@/assets/svg/adhder-logo.svg?raw';
