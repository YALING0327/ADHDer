    ...
    push = {
      notifications: {
        ...
        data: {
          ...
          text: 'To celebrate the day we became Adhder, we’ve awarded you some cake!',
    ...
    push = {
      notifications: {
        ...
        data: {
          ...
          title: 'Happy Naming Day!',
          text: 'To celebrate the day we became Adhder, we’ve awarded you a Royal Purple Gryphon Tail and cake!',
    ...
    push = {
      notifications: {
        ...
        data: {
          ...
          title: 'Happy Naming Day!',
          text: 'To celebrate the day we became Adhder, we’ve awarded you a Royal Purple Gryphon Cloak and cake!',
          destination: '/inventory/equipment',
        },
        seen: false,
      },
    ...
    push = {
      notifications: {
        ...
        data: {
          ...
          title: 'Happy Naming Day!',
          text: 'To celebrate the day we became Adhder, we’ve awarded you a Royal Purple Gryphon Helm and cake!',
          destination: '/inventory/equipment',
        },
        seen: false,
      },
    ...
    push = {
      notifications: {
        ...
        data: {
          ...
          title: 'Happy Naming Day!',
          text: 'To celebrate the day we became Adhder, we’ve awarded you a Royal Purple Gryphon Pet and cake!',
    ...
    push = {
      notifications: {
        ...
        data: {
          ...
          title: 'Happy Naming Day!',
          text: 'To celebrate the day we became Adhder, we’ve awarded you a Royal Purple Gryphon Mount and cake!',
          destination: '/inventory/stable',
        },
        seen: false,
      },
