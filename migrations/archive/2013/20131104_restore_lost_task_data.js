 ...
 * schemas became more strict. See conversation at https://github.com/AdhderApp/adhderapp/issues/1712 ,
...
let backupUsers = mongo.db('localhost:27017/adhderapp_old?auto_reconnect').collection('users');
let liveUsers = mongo.db('localhost:27017/adhderapp_new?auto_reconnect').collection('users');
