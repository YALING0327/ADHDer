 ...
 * https://github.com/AdhderApp/adhderapp/pull/7987
...
const message = '`This party\'s collection quest has been made easier! For details, refer to https://adhder.fandom.com/wiki/User_blog:LadyAlys/Collection_Quests_are_Now_Easier`';

const timer = new Timer();

// PROD: Enable prod db
// const DB_URI = 'mongodb://username:password@dsXXXXXX-a0.mlab.com:XXXXX,dsXXXXXX-a1.mlab.com:XXXXX/adhder?replicaSet=rs-dsXXXXXX';
const DB_URI = 'mongodb://localhost/adhderapp';
