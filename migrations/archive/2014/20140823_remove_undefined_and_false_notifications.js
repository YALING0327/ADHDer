...
/**
 * https://github.com/AdhderApp/adhderapp/pull/3907
 */
...
// var liveUsers = mongo.db('lefnire:mAdn3s5s@charlotte.mongohq.com:10015/adhderapp_large?auto_reconnect').collection('users');
// var liveUsers = mongo.db('localhost:27017/adhderapp_old?auto_reconnect').collection('users');

// For local testing by script author:
// var liveUsers = mongo.db('localhost:27017/adhderapp?auto_reconnect').collection('users');
